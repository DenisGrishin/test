/******/ (() => {
  // webpackBootstrap
  /******/ "use strict"; // CONCATENATED MODULE: ./src/js/header.js
  ...
  } // CONCATENATED MODULE: ./src/js/insta-stories.js
...
*/
    ...
    function showMore() {
      ...
      if (showMoreBlocks.length) {
        ...
        document
          .querySelectorAll("[data-showmore-button]")
          .forEach((element) => {
...
*/
    ...
    function initSliders() {
      ...
      // ========================================================================================================================================================================================================================
      const insideSliderAll = document.querySelectorAll(
        ".inside-slider__slider",
      );
      ...
      if (insideSliderAll) {
        ...
        insideSliderAll.forEach((slider, indx) => {
          ...
          if (document.querySelector(`.inside-slider__slider_${indx}`)) {
            ...
            paginationSelector.classList.add(
              `inside-slider__pagination_${indx}`,
            );
    ...
    function tabModificationModel() {
      ...
      if (slidesModel) {
        slidesModel.addEventListener("click", function (e) {
          ...
          const slideModel = document.querySelectorAll(
    ...
    function initQwiz() {
      ...
      if (qwizFrom) {
        ...
        const chekBoxInpt = document.querySelectorAll(
          ".form-qwiz__input-check",
        );
        const chekBoxInptService =
          document.querySelectorAll(".form-qwiz__input");
        ...
        function isCheck() {
          if (document.querySelector("._active-additional-question")) {
            if (
              document.querySelector("._active-additional-question").checked
            ) {
    ...
    function filterSeptik() {
      ...
      function showReusltSeptik(res) {
        ...
        const sumNameSelector = document.querySelector(
          ".form-qwiz__sum-finish",
        );
      ...
      if (document.querySelector(".calc-vodosnabzhenie")) {
        ...
        sumBtn.addEventListener("click", function (e) {
          ...
          const isObustroistva = Number(twoValueSelect)
            ...
            : 0;
          const vidObustroistva =
            findValueOption(oneSelect).dataset.obustroystva;
          const areaWellsValue =
            findValueOption(threeSelect).dataset.valueDepth;
